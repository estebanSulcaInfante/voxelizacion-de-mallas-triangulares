...
// ============================================================================
// Carga de malla PLY usando happly (header-only)
// ============================================================================
...
Mesh loadPLY(const std::string& path) {
    ...
    try {
        ...
        // Obtener posiciones de vértices
        std::vector<std::array<double, 3>> vPos = plyData.getVertexPositions();

        // Obtener índices de caras (triángulos)
        ...
        for (const auto& face : fInd) {
            ...
            // Si la cara tiene más de 3 vértices, triangular con fan
        ...
        std::cout << "  Vertices: " << vPos.size() << std::endl;
