...
// 
// Uso: voxelizer <mesh.ply> <resolution> [--export-ply output.ply] [--export-raw output.raw]
//
// Ejecuta los 4 algoritmos de voxelización secuencial y reporta tiempos.
// ============================================================================

void printUsage(const char* progName) {
    std::cout << "Uso: " << progName << " <mesh.ply> <resolution> [opciones]" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "  " << progName << " bunny.ply 256 --export-ply output.ply" << std::endl;
}
...
int main(int argc, char* argv[]) {
    ...
    // Parsear opciones
    std::string exportPLY, exportRAW;
    ...
    // ---- Resultados ----
    double totalTs = timer1.elapsedMs() + timer2.elapsedMs() +
                     timer3.elapsedMs() + timer4.elapsedMs();
